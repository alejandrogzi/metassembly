...
process BAMSPLIT_CHROM {
    ...
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        '' :
        'ghcr.io/alejandrogzi/bamsplit@sha256:debfa723a05be795f03b403d58fc4331acf380ba139c5be7c1b41d100d0c6fe0' }"
    ...
    """
    mkdir -p $out_dir
    touch $out_dir/chr1.bam $out_dir/chr1.bam.bai $out_dir/chr1.json
    touch $out_dir/chr2.bam $out_dir/chr2.bam.bai $out_dir/chr2.json
